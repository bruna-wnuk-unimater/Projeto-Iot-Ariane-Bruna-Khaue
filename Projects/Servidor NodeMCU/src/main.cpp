...
IPAddress local_IP(192,168,219,220); //Troque o IP
IPAddress gateway(192,168,219,200);
...
void handleRoot() {
  ...
  html += "<h2>Ariane, Bruna e Khaue</h2>";
  html += "<button onclick=\"toggleLED('off')\" class=\"button\">OFF</button>";
  html += "<button onclick=\"toggleLED('on')\" class=\"button button2\">ON</button>";
  html += "<script>";
